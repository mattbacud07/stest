        ...
        <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
          <div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
            ...
            <div class="text-center">
              <p class="tx-16 fw-bolder">{{Auth::guard('usersSecond')->user()->first_name}}</p>
              <p class="tx-12 text-muted">{{Auth::guard('usersSecond')->user()->email}}</p>
            </div>
          </div>
          <ul class="list-unstyled p-1">
            ...
            <li class="dropdown-item py-2">
              <form action="{{route('logmeout')}}" method="post">
                @csrf
                <button href="javascript:;" type="submit" class="text-body ms-0 border-0" style="background: none;">
